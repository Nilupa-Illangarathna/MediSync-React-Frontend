    ...
    >
      ...
      >
        ...
        <Typography variant="body1" paragraph sx={{ fontSize: "1.2rem" }}>
          Welcome to MediSync, your comprehensive healthcare management platform. By accessing or using our services, you agree to comply with and be bound by the following terms and conditions:
        </Typography>
